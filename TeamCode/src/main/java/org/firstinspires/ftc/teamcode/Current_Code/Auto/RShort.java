...
@Autonomous(name="RShort", group="Robot")
public class RShort extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        switch (snapshotAnalysis) {
            ...
            case CENTER: // Level 2
            {
                ...
                //park
                Move(directions.FORWARDS, 3, .35);
                Move(directions.LEFT, 24, .25);
                Move(directions.BACKWARDS, 21, .25);
                Move(directions.LEFT, 24, .25);
                break;
