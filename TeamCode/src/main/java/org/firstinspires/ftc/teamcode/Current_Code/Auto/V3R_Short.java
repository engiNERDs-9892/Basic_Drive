...
public class V3R_Short extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        switch (snapshotAnalysis) {
            ...
            case CENTER: // Level 2
            {
                ...
                //go to target
                Move(directions.FORWARDS, 22, .25);
                Move(directions.CLOCKWISE, 17, .25);
                Move(directions.LEFT,3,.25);
    ...
    private void Move(directions direction, int target, double speed) {
        ...
        if (direction == V3R_Short.directions.FORWARDS) {
        ...
        else if (direction == V3R_Short.directions.BACKWARDS) {
        ...
        else if (direction == V3R_Short.directions.LEFT) {
            motorFL.setDirection(DcMotorSimple.Direction.REVERSE);
            motorFR.setDirection(DcMotorSimple.Direction.REVERSE);
            motorBL.setDirection(DcMotorSimple.Direction.FORWARD);
            motorBR.setDirection(DcMotorSimple.Direction.FORWARD);
        ...
        else if (direction == V3R_Short.directions.RIGHT) {
            motorFL.setDirection(DcMotorSimple.Direction.FORWARD);
            motorFR.setDirection(DcMotorSimple.Direction.FORWARD);
            motorBL.setDirection(DcMotorSimple.Direction.REVERSE);
            motorBR.setDirection(DcMotorSimple.Direction.REVERSE);
