...
@Autonomous(name="camera_Testing",group="used")
//@Disabled
public class Blue_Auto_Centuars extends LinearOpMode {
    ...
    // pipeline is a mario reference


    OpenCvWebcam webcam;
    Blue.SkystoneDeterminationPipeline pipeline;
    Blue.SkystoneDeterminationPipeline.SkystonePosition snapshotAnalysis = Blue.SkystoneDeterminationPipeline.SkystonePosition.LEFT; // default
